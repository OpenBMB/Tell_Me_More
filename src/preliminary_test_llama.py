...
# access_token = "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"
...
i = -1
for i, data in enumerate(test_dataset[91:]):
        ...
        if not back_flag:
            ...
            while round < 3:
                ...
                try:
                    ...
                    pred = pred.split(prompt)[-1].strip()
                    ...
                    if has_initial_thought == 'y':
                        ...
                        if has_summary == 'y':
                            ...
                            if inappropriate_options != 0:
                                inappropriate_options_reasons = input("Give some reasons why: ").strip()
